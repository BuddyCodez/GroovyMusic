...
import { z } from "zod";
import { searchForAlbums, searchForArtists, searchForMusic, searchForPlaylists } from "youtube-music-apis";
function thumbnailFormatter(thumbnailUrl?: string): { url?: string; size: string }[] {
    ...
    const sizes = ["w120-h120-l90-rj", "w256-h256-l90-rj", "w512-h512-l90-rj", "w1080-h1080-l90-rj",];
